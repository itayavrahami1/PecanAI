...
def linear_regression_model(X_train, y_train, X_test, y_test, columns):
    """
    :param X_train:
    :param y_train:
    :param X_test:
    :param y_test:
    :param columns: The df columns for Coefficients use
    :return: predictions after creating a model
    """
    lm = LinearRegression()
    lm.fit(X_train, y_train)

    coeffecients = pd.DataFrame(lm.coef_, columns)
